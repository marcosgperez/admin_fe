...
const CardListBlog = [
	{
		...
		Cust_Name: "Munaroh Steffani", Location: "India", assignedEmployee: "John Doe"
	},
	{
		id: 2, image: card2, Cust_Id: "01235", Date_Join: "20/03/2022",
		Cust_Name: "Geovanny Anderson", Location: "London " , assignedEmployee: "John Doe"
	},
	{
		id: 3, image: card3, Cust_Id: "01236", Date_Join: "21/04/2022",
		Cust_Name: "Louis Ali", Location: "Afghanistan", assignedEmployee: "John Doe"
	},
	{
		id: 4, image: card4, Cust_Id: "01237", Date_Join: "22/05/2022",
		Cust_Name: "Marquezz", Location: "Belgium", assignedEmployee: "John Doe"
	},
	{
		id: 5, image: card5, Cust_Id: "01238", Date_Join: "23/06/2022",
		Cust_Name: "Richard ", Location: "Colombia", assignedEmployee: "John Doe"
	},
	{
		id: 6, image: card6, Cust_Id: "01239", Date_Join: "24/07/2022",
		Cust_Name: "Andrew Stevano", Location: "Czechia", assignedEmployee: "John Doe"
	},
	{
		id: 7, image: card7, Cust_Id: "01240", Date_Join: "25/08/2022",
		Cust_Name: "Cathenna ", Location: "El Salvador", assignedEmployee: "John Doe"
	},
	{
		id: 8, image: card8, Cust_Id: "01241", Date_Join: "26/09/2022",
		Cust_Name: "Hrisovalantis ", Location: "Guatemala", assignedEmployee: "John Doe"
	}
];
						...
						<div className="card project-boxed">
							...
							<div className="card-header align-items-start">
								<div>
									...
									<div className="text-dark fs-14 text-nowrap"><i className="far fa-calendar-alt me-2" aria-hidden="true"></i>Created on May 7th, 2022</div>
								</div>
								<Dropdown className="">
							...
							<div className="card-body p-0 pb-3">
								<ul className="list-group list-group-flush">
									...
									<li className="list-group-item">
										...
										<span className="text-black desc-text ms-2">{contact.assignedEmployee}</span>
									</li>
								</ul>
							</div>
